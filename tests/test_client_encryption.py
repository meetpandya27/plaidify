...
class TestCryptoModule:
    ...
    def test_generate_and_retrieve_keypair(self):
        from src.crypto import _clear_all_keys, generate_keypair, get_public_key
    ...
    def test_encrypt_decrypt_roundtrip(self):
        from src.crypto import _clear_all_keys, decrypt_with_session_key, generate_keypair
    ...
    def test_decrypt_invalid_link_token(self):
        from src.crypto import _clear_all_keys, decrypt_with_session_key
    ...
    def test_destroy_session_key(self):
        from src.crypto import _clear_all_keys, destroy_session_key, generate_keypair, get_public_key
    ...
    def test_cleanup_expired_keys(self):
        ...
        from src.crypto import _clear_all_keys, _key_store, _lock, cleanup_expired_keys
